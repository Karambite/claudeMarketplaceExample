...
description: SCCode resource API reference for TI Sensor Controller peripherals. Use for questions about ADC, ADC Window Monitor, GPIO input/output/bidirectional, I²C Master, SPI Master, UART Emulator, SC Timer 0/1/2, COMPA/COMPB analog comparators, Math/Accumulator helpers, RTC-based scheduling, System CPU alert, delay insertion, AON domain access, RTL logging, or the scif I/O init helpers.
---
