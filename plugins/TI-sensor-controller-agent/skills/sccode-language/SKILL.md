---
name: sccode-language
description: SCCode language reference for the TI Sensor Controller. Use for questions about SCCode syntax, data types (u8/u16/s16/u32/s32/bool), task blocks (Initialize/Execute/Terminate/EventHandler), shared data structs (cfg/input/output/state), framework functions (fwScheduleTask, fwGenAlertInterrupt, fwRtlLogU16), operators, AUXIO pin constants and DIO mapping, ADC/GPIO constants, or the 16.16 fixed-point RTC tick period format.
---
