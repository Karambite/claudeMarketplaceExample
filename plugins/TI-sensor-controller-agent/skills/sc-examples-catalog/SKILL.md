---
name: sc-examples-catalog
description: Catalog of Sensor Controller Studio example projects (ADC, I²C, SPI, GPIO/pulse, comparator, communication, data logger patterns). Use to recommend an .scp starter project for a specific sensor, peripheral, or pattern (e.g., HDC1000, MPU-9250, ADXL362, OPT3001, PWM, pulse counting, capacitive sense, moving average) and to see which chip families each example supports.
---
