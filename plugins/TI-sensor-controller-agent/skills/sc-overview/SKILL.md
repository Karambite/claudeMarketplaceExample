---
name: sc-overview
description: TI Sensor Controller (CC13xx/CC26xx AUX-domain co-processor) architectural overview. Use for questions about chip family support, AUX RAM sizing, execution flow between System CPU and Sensor Controller, SDK directory layout, Sensor Controller Studio installation, and the communication model over shared AUX RAM with SWEV0/SWEV1 interrupts.
---
